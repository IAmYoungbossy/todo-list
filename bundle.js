...
function toggleEvents(task, myTaskDots, myUndoneTask, myUncheckedStar) {
  myTaskDots.addEventListener("click", _delete_edit_pop_up__WEBPACK_IMPORTED_MODULE_1__.popUpDeleteAndEdit.bind(myTaskDots, task));
